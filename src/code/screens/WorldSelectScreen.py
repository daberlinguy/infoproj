...
class WorldSelectScreen(Screen):
    ...
    def run(self):
        ...
        self.draw_text("Worlds", getFont(60), 255, 255, 255,
                       (self.screen.get_width() / 2) - 120, (self.screen.get_height() / 2) - 260)

        if not self.world_ids:
            self.draw_text("No worlds found in ./data/worlds", getFont(24), 255, 255, 255,
            ...
            for idx, row_rect in enumerate(self.row_rects):
                ...
                border_color = (40, 200, 40) if is_completed else ((160, 160, 160) if is_selected else ((140, 140, 140) if is_hovered else (90, 90, 90)))
                ...
                self.draw_text(world["name"], getFont(28), 255, 255, 255, row_rect.x + 20, row_rect.y + 20)
